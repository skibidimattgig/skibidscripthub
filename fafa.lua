...
local scripts = {
	...
	["отчим тварь (вх)"] = {"https://raw.githubusercontent.com/zzerexx/scripts/main/UniversalEspUI.lua", 1},--https://raw.githubusercontent.com/Lucasfin000/SpaceHub/main/UESP
